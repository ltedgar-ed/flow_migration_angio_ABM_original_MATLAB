...
file_tag = '_2019_03_29_new_branch_rule_2';
...
[P, Q] = solve_for_flow_Ub1(G, Pin, Pout);                     % Solve for nodal pressure (Pa) and segment flow (m3/s)
...
% Plot the network
plot_network_Ub1(segments, D, P, Q, seg_cells)                             
...
for t = 1:Nt   
    ...
    for seg = 1:Nseg                                                
        ...
        [seg_cells, new_seg_cells] = cell_migration_Ub1(seg, seg_cells, new_seg_cells, migrate, Q, branch_rule);
    ...
    [P, Q] = solve_for_flow_Ub1(G, Pin, Pout);                                % Solve for nodal pressure and segment flow
  
    plot_network_Ub1(segments, D, P, Q, seg_cells)                            % Plot the network
